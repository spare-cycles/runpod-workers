...
what that removal buys back. `git log -- transcribe/backends/whisper_fr.py` restores it.
...
`chat` mode's answer goes through [`transcribe/guards.py`](guards.py) — rejected if it is shorter
